        ...
        <div class="bg-white p-6 rounded shadow">
            ...
            <form action="{{ route('buku.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <select name="penerbit_id" id="penerbit_id"
                        ...
                        @foreach ($penerbits as $item)
                            <option value="{{ $item->id }}" {{ old('penerbit_id') == $item->id ? 'selected' : '' }}>
                                {{ $item->nama_penerbit }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="cover" id="cover" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4
